/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e1df88d721fd1fda913cc86f9584f357)
// Runtime types generated with workerd@1.20250709.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PLAYLIST_KV_CACHE: KVNamespace;
		PROFILE_KV_CACHE: KVNamespace;
		PROJECT_KV_CACHE: KVNamespace;
