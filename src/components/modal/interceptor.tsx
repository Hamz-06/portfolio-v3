...
function ProjectInterceptorPage() {
  ...
  return (
    <Dialog
      ...
      <DialogContent
        className='min-w-4/5 max-h-4/5 min-h-4/5 z-50  p-4 backdrop-blur-sm 
          shadow-2xl animate-fadeIn overflow-auto'
        style={{
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row h-full w-full">
          ...
          <div className="lg:w-1/2 bg-black/30 backdrop-blur-sm overflow-y-auto max-h-[50vh] 
          md:max-h-[85vh] m-2 p-6 flex flex-col">
            {/* <div className="p-6"> */}
