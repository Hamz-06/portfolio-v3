...
function ProjectRows({
  ...
  return (
    <section className="mb-8 w-full overflow-auto pl-7">
      ...
      <div className="grid gap-2 grid-flow-col auto-cols-[50%] sm:auto-cols-[21%] xl::auto-cols-[17%] h-full overflow-auto">
        {children}
      </div>

      {/* <div className="grid gap-4 grid-cols-2 sm:grid-cols-4 xl:grid-cols-6">
        {children}
      </div> */}
    </section>
